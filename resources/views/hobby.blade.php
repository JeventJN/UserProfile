...
<body>
    <div class="relative w-screen h-screen bg-gradient-to-tl from-yellow-500 to-orange-500 ">
        <div class="absolute flex h-screen items-center ml-[160px]">
            <div class="relative mx-auto w-96 overflow-hidden rounded-[16px] p-[1px]">
                <div class="rounded-[15px] bg-white bg-opacity-50 p-6">
                    <div class="space-y-2">
                        <img src="Assets/StravaRunning.jpeg" class="rounded-[15px]" alt="" />
                        <p class="text-center text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-black-800 to-red-400">Runner!!!</p>
                        <p class="font-md text-black-500 text-center">Running is my life. My life is about running. I've been running for 5 years. Everyday is new opprotunity to challenge myself and become a better runner. </p>
                    </div>
                </div>
            </div>
        </div>

        <div class="absolute flex h-screen items-center ml-[20px]">
            <div class="absolute h-[455px] w-[250px] flex flex-col space-y-[19.25px]">
                <div class="flex shadow-md rounded-xl ml-[570px] bg-white bg-opacity-50 items-center w-[250px] h-[80px] justify-content">
                    <img src="Assets/ELITE.PNG" alt="" class="ml-[20px] w-16 h-16 rounded-full dark:bg-gray-500 aspect-square ml-4">
                        <div class="space-y-4 text-center divide-y divide-gray-700">
                        <div class="my-2 space-y-1">
                            <h2 class="text-xs sm:text-2xl">Founder of</h2>
                            <p class="px-5 text-xl font-black sm:text-base dark:text-gray-400">ELITE RTB CLUB</p>
                        </div>
                    </div>
                </div>

                <div class="flex shadow-md rounded-xl ml-[570px] bg-white bg-opacity-50 items-center w-[250px] h-[80px] justify-content">
                    <img src="Assets/1k.PNG" alt="" class="ml-[20px] w-16 h-16 rounded-full dark:bg-gray-500 aspect-square ml-4 ">
                    <div class="space-y-4 text-center divide-y divide-gray-700">
                        <div class="my-2 space-y-1">
                            <h2 class="text-xs sm:text-2xl">Best Time</h2>
                            <p class="animate-pulse hover:animate-none px-[60px] text-19xl font-black sm:text-base dark:text-gray-400">03:30</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex shadow-md rounded-xl ml-[570px] bg-white bg-opacity-50 items-center w-[250px] h-[80px] justify-content">
                    ...
                    <div class="space-y-4 text-center divide-y divide-gray-700">
                        <div class="my-2 space-y-1">
                        <h2 class="text-xs sm:text-2xl">Best Time</h2>
                            <p class="animate-pulse hover:animate-none px-[60px] text-19xl font-black sm:text-base dark:text-gray-400">23:38</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative bg-gray-50 dark:bg-slate-900 w-screen pattern">
            ...
            <a
                href="education"
                class="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 white:hover:bg-slate-800"
            >
                <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
                href="hobby"
                class="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 bg-indigo-50 text-indigo-600 hover:bg-slate-800"
            >
                <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
